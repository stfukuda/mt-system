...
@parametrize_with_checks(
    [
        MT(method="mt", kind="p", return_sqrt=False),
        MT(method="mt", kind="p", return_sqrt=True),
        ...
        MT(method="mta", kind="p", return_sqrt=False),
        MT(method="mta", kind="p", return_sqrt=True),
        ...
        MT(method="svp", kind="p", return_sqrt=False),
        MT(method="svp", kind="p", return_sqrt=True),
